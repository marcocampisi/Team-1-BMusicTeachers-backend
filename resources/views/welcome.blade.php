...
<div class="row">
  <div class="col-lg-8 col-12 welcome-blur">
      ...
      <h2 class=" text-start mt-3">
        <strong class="text-success ">Musicisti in rete</strong> è una piattaforma musicale unica che permette agli artisti indipendenti di condividere la propria musica con il mondo.
      </h2>
